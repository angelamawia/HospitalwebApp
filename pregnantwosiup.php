...
<body>
     <!--<h2>Sign Up Form-->
    <form action="Psignup.php" method="post" class="container">
    <fieldset>
      <legend><h2>Patients Registration</h2></legend>
    ...
    <input type="text" placeholder="Enter Email" name="email" required  patten="^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$" title="Please enter a valid email address"><br>
